...
<body>
<h1>Notes Manager</h1>
<h4><a href="form.php">Add Notes</a> / <a href="logoff.php">Log out</a></h4>
<table id="customers">
<thead><tr>
<th align='left' width="20%">Title</th>
<th align='left' width="80%">Notes</th>
...
foreach($result as $row)
{
    ...
    $rowColor = "class='alt'";
	echo "<tr $rowColor>" . "<td>" . stripslashes($row['Title']) . "</td>" . "<td>" . $row['Notes'] . "</td><td width='20'><a href='delete.php?id=" . $row['rowid'] . "'><img src='remove.png' border='0'></a></td>" . "</tr>\n";
	$i++;
}
$db = NULL;
/*
